...
public class TestArgsDump implements Opcodes {
	...
	public static byte[] dump() throws Exception {
		...
		cw.visit(V1_6, ACC_PUBLIC + ACC_SUPER, "TestArgs", null, "java/lang/Object", null);

		cw.visitSource("TestArgs.java", null);

		cw.visitInnerClass("java/util/Map$Entry", "java/util/Map", "Entry", ACC_PUBLIC + ACC_STATIC + ACC_ABSTRACT
				+ ACC_INTERFACE);
		...
		}
		{
			...
			Label l5 = new Label();
			mv.visitLabel(l5);
			mv.visitFrame(Opcodes.F_FULL, 5, new Object[] { "[Ljava/lang/String;", Opcodes.TOP, Opcodes.INTEGER,
					Opcodes.INTEGER, "[Ljava/lang/String;" }, 0, new Object[] {});
			...
			mv.visitMethodInsn(INVOKESTATIC, "java/lang/System", "getProperties", "()Ljava/util/Properties;");
			mv.visitVarInsn(ASTORE, 1);
			Label l9 = new Label();
			mv.visitLabel(l9);
			mv.visitLineNumber(16, l9);
			mv.visitVarInsn(ALOAD, 1);
			mv.visitMethodInsn(INVOKEVIRTUAL, "java/util/Properties", "entrySet", "()Ljava/util/Set;");
			...
			Label l11 = new Label();
			mv.visitLabel(l11);
			mv.visitFrame(Opcodes.F_FULL, 4, new Object[] { "[Ljava/lang/String;", "java/util/Properties", Opcodes.TOP,
			...
			mv.visitMethodInsn(INVOKEVIRTUAL, "java/io/File", "createNewFile", "()Z");
			mv.visitInsn(POP);
			mv.visitLabel(l1);
			Label l13 = new Label();
			...
			mv.visitFrame(Opcodes.F_FULL, 2, new Object[] { "[Ljava/lang/String;", "java/util/Properties" }, 1,
			...
			Label l15 = new Label();
			mv.visitLabel(l15);
			mv.visitLocalVariable("args", "[Ljava/lang/String;", null, l3, l15, 0);
			mv.visitLocalVariable("s", "Ljava/lang/String;", null, l6, l7, 1);
			mv.visitLocalVariable("properties", "Ljava/util/Properties;", null, l9, l15, 1);
			mv.visitLocalVariable("e", "Ljava/util/Map$Entry;", null, l12, l10, 2);
			mv.visitLocalVariable("e1", "Ljava/io/IOException;", null, l14, l13, 2);
			mv.visitMaxs(3, 5);
			mv.visitEnd();
		}
		cw.visitEnd();
